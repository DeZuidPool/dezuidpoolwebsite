               ...
               <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12">
                         <div class="section-title wow fadeInUp" data-wow-delay="0.1s">
                              <h2>Beste <?php echo $firstName;?> <?php echo $name; ?>, registreer hier een adres om te kunnen leveren.</h2>
                         </div>
					...
					<table class="table">
						<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);#bestellen?>" method="post">
							<input type="text" hidden="true" value="<?php echo $customerId; ?>">
    						<tr>
    							<td align="left">
    								Straat: 
    							</td>
    						...
    						<tr>
    							...
    							<td align="left">
    								<input type="password" name="city" value="<?php echo $city?>">
